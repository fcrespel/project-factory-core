...
PF_REPO_RELEASES_LIST="deb https://services.crespel.me/nexus/repository/project-factory-releases-debian9/ debian9 main"
PF_REPO_SNAPSHOTS_ENABLED="1"
PF_REPO_SNAPSHOTS_LIST="deb https://services.crespel.me/nexus/repository/project-factory-snapshots-debian9/ debian9 main"
