...
ITTB_OSS_REPO_RELEASES_LIST="deb https://cgi.it-toolbox.fr/repos/apt/oss-releases/ debian9 main"
ITTB_OSS_REPO_SNAPSHOTS_ENABLED="1"
ITTB_OSS_REPO_SNAPSHOTS_LIST="deb https://cgi.it-toolbox.fr/repos/apt/oss-snapshots/ debian9 main"
