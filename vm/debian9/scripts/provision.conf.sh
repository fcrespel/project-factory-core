...
PF_REPO_RELEASES_LIST="deb https://forge.crespel.me/repos/apt/project-factory-releases/ debian9 main"
PF_REPO_SNAPSHOTS_ENABLED="1"
PF_REPO_SNAPSHOTS_LIST="deb https://forge.crespel.me/repos/apt/project-factory-snapshots/ debian9 main"
