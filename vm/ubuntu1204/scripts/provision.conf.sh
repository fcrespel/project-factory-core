...
ITTB_OSS_REPO_RELEASES_LIST="deb https://cgi.it-toolbox.fr/repos/apt/oss-releases/ ubuntu1204 main"
ITTB_OSS_REPO_SNAPSHOTS_ENABLED="1"
ITTB_OSS_REPO_SNAPSHOTS_LIST="deb https://cgi.it-toolbox.fr/repos/apt/oss-snapshots/ ubuntu1204 main"
